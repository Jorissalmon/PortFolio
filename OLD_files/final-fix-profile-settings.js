...
📩 Contact direct: joris.salmon53290@gmail.com | 📱 0766840946`,
    // aboutDescription: maintenant un seul champ Text avec paragraphes séparés par \n\n
...
async function finalFix() {
    ...
    log('🔧 Correction finale du Content Model et insertion des données...\n');
    ...
    try {
        ...
        try {
            log('🗑️  Suppression de l\'ancien content type...');
            ...
            log('✅ Ancien content type supprimé\n');
        } catch (error) {
            log('ℹ️  Aucun ancien content type à supprimer\n');
        }

        // ÉTAPE 2: Supprimer les anciennes entrées
        try {
            log('🗑️  Suppression des anciennes entrées...');
            ...
            log('✅ Anciennes entrées supprimées\n');
        } catch (error) {
            log('ℹ️  Aucune ancienne entrée à supprimer\n');
        }

        // ÉTAPE 3: Créer le nouveau content type CORRECT
        log('📐 Création du nouveau content type...');
        ...
        const contentType = await environment.createContentTypeWithId('profileSettings', {
            ...
            fields: [
                ...
                },
                {
                    ...
                    type: 'Text',  // UN SEUL CHAMP TEXT, pas un Array
                    required: false
                },
                {
                    id: 'cvLink',
