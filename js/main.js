    ...
    particlesJS('particles-js', {
      particles: {
        ...
        line_linked: {
          enable: true,
          distance: 150,
          color: '#00f3ff', // Cyan for connections
          opacity: 0.4,
          width: 1
        },
        move: {
...
function initializeSkillBars() {
  ...
  function animateBar(bar) {
    ...
    console.log(`Animating bar to ${width}%`);
  ...
  // Force trigger after a delay to ensure visibility
  setTimeout(() => {
    animateAllBars();
  }, 1000);

  // Also trigger on intersection observer if possible
  const skillsSection = document.querySelector('.skills-section') || document.querySelector('#a-propos');
  if (skillsSection) {
