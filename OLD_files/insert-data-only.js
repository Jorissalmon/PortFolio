...
async function insertProfileData() {
    console.log('📝 Insertion des données profileSettings...\n');
    ...
    try {
        ...
        // Créer l'entrée
        console.log('Création de l\'entrée...');
        ...
        console.log('Champs à envoyer:');
        console.log(JSON.stringify(fields, null, 2));
        console.log('');

        const entry = await environment.createEntry('profileSettings', { fields });

        console.log('Publication de l\'entrée...');
        const publishedEntry = await entry.publish();

        console.log('\n✅ Entrée profileSettings créée et publiée avec succès!');
        console.log(`   ID: ${publishedEntry.sys.id}`);
        console.log('\n🎉 Terminé! Vérifiez sur https://app.contentful.com\n');
